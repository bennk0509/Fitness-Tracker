...
//                        }
                    ...
                    VStack(alignment:.leading){
                        ...
                        HStack(spacing: 14){
                            StatFitnessCard(iconName: "figure.walk", number: $vm.move, text: "Steps")
                            StatFitnessCard(iconName: "flame.fill", number: $vm.caloriesBurned, text: "Cal Out", unit: "Kcal")
                            StatFitnessCard(iconName: "figure.strengthtraining.traditional", number: $vm.exercise, text: "Exercise", unit: "min")
                        }
                    }
